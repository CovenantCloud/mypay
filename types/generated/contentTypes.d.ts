...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    EstDark: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    etat: Attribute.String &
      Attribute.Required &
      Attribute.Private &
      Attribute.DefaultTo<'ACTIF'>;
    services: Attribute.Relation<
      'api::category.category',
      'oneToMany',
      'api::service.service'
    >;
    reseau: Attribute.Relation<
      'api::category.category',
      'manyToOne',
      'api::reseau.reseau'
    >;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    etat: Attribute.String &
      ...
      Attribute.Private &
      Attribute.DefaultTo<'ACTIF'>;
    montant: Attribute.Integer & Attribute.Required;
    ussd: Attribute.String;
    ...
    reseau: Attribute.Relation<
      ...
      'api::reseau.reseau'
    >;
    typeservice: Attribute.Relation<
      'api::service.service',
      'manyToOne',
...
export interface ApiTransactionTransaction extends Schema.CollectionType {
  ...
  attributes: {
    description: Attribute.String;
    montant: Attribute.Integer & Attribute.Required;
    commission: Attribute.Integer & Attribute.Required;
...
export interface ApiTypeserviceTypeservice extends Schema.CollectionType {
  ...
  attributes: {
    ...
    transactions: Attribute.Relation<
      ...
      'api::transaction.transaction'
    >;
    icone: Attribute.BigInteger;
    iconColor: Attribute.BigInteger;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::typeservice.typeservice',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::typeservice.typeservice': ApiTypeserviceTypeservice;
    }
  }
}
